namespace MassTransit.Conductor.Inventory
{
        ...
        IDisposable
    {
        ...
        public void AddStep<TInput, TResult>(Func<IServiceProviderSelector<TInput, TResult>, IServiceProviderDefinition<TInput, TResult>> providerSelector,
        ...
        public IServiceCatalog BuildServiceCatalog()
        {
            ValidateRegistration();

            return new ServiceCatalog(_registrations);
        }

        public void Connect(IBusFactoryConfigurator configurator)
        {
            var configurationObserver = new ServiceRegistryConfigurationObserver(configurator, this);
